# AZ-204: Microsoft Azure용 솔루션 개발
...
> **참고**: 랩 호스팅 공급자를 통해 AllFiles가 제공되지 않는 경우 학생은 리포지토리를 동기화하도록 지시해야 합니다. 
...
**수정**: 학생은 자신이 선택한 암호를 사용하도록 지시받아야 합니다. 학생들은 랩 지침의 암호를 사용하면 안 됩니다. 암호를 제거하기 위한 랩 단계가 이번 주에 업데이트됩니다. 
