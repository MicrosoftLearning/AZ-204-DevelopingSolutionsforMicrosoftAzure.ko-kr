...
ms.locfileid: "145995001"
---
# <a name="lab-04-develop-solutions-that-use-azure-cosmos-db"></a>랩 04: Azure Cosmos DB를 사용한 솔루션 개발
...
1.  **API 옵션 선택** 창의 **코어(SQL) - 권장** 상자에서 **만들기** 를 선택합니다.
...
1.  
    ...
    다.  
          **파일이 이미 있는 경우 덮어쓰기** 가 선택되어 있는지 확인하고 **업로드** 를 선택합니다.
...
1.  줄 18에서 빈 문자열을 **“/Category”** 로 바꿔 **PrimaryKey** 의 값을 설정합니다.
