...
1. 다음 명령을 실행하여 NuGet에서 **Azure.Messaging.EventGrid** 버전 4.11.0을 가져옵니다.
    ...
    > **참고**: **dotnet add package** 명령은 NuGet에서 **Azure.Messaging.EventGrid** 패키지를 추가합니다. 더 자세한 내용은 [Azure.Messaging.EventGrid](https://www.nuget.org/packages/Azure.Messaging.EventGrid/4.11.0)를 참조하세요.
