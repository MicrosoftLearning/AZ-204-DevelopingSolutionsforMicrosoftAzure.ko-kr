...
1. **구성** 섹션에서 다음 작업을 수행하고 **저장**을 선택한 다음, **계속**을 선택합니다.
    ...
    | **값** 텍스트 상자 | Enter the web app URL that you copied previously in this lab. <bpt id="p1">**</bpt>Note<ept id="p1">**</ept>: Make sure you include the protocol, such as <bpt id="p2">**</bpt>https://<ept id="p2">**</ept>, in the URL that you copy into the <bpt id="p3">**</bpt>Value<ept id="p3">**</ept> text box for this application setting |
