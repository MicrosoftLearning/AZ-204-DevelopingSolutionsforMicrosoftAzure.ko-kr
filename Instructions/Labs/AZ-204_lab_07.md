...
1. **키 자격 증명 모음 만들기** 블레이드의 **기본 사항** 탭에서 다음 작업을 수행한 후 **액세스 구성** 탭을 선택합니다.
...
1. **액세스 구성** 탭에서 권한 모델을 **Vault 액세스 정책**으로 변경합니다.
...
1. 19행으로 시작하는 **FileParser** 함수의 자동 생성 코드 콘텐츠를 다음 코드로 바꿉니다.
